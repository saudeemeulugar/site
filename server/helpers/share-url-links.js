...
module.exports = function(we) {
  return function helper() {
    ...
    let html = `
      <a href="https://twitter.com/intent/tweet?url=${url}" class="s-twitter" target="_blank">
      ...
      <a href="whatsapp://send?text=${title}: ${url}" data-action="share/whatsapp/share" class="s-whatsapp-mobile"><img src="/public/project/icons/whatsapp.png" alt="Compartilhar no Whatsapp" /></a>
      <a href="https://web.whatsapp.com/send?text=${title}: ${url}" data-action="share/whatsapp/share" class="s-whatsapp-site" target="_blank"><img src="/public/project/icons/whatsapp.png" alt="Compartilhar no Whatsapp" /></a>
